...
RunnerHand é um timer de speedrun amador desenvolvido em Java, projetado para streamers e speedrunners que precisam de controle preciso sobre splits com recursos avançados de personalização.
--------------------------------------------------------------------------------------
✨ Recursos Principais
--------------------------------------------------------------------------------------
🎯 Controle de Splits
